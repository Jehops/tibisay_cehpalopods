...
## How many times does the most common AA in ogeo match most common AA in the out group?
sum(max.freq.ogeo == max.freq.outg)/length(pats.to.show)

## How many times does the most common AA in loli match most common AA in the out group?
sum(max.freq.loli == max.freq.outg)/length(pats.to.show)

## How many times does the most common AA in groe match most common AA in the out gropu?
sum(max.freq.groe == max.freq.outg)/length(pats.to.show)

## How many times does the most common AA in ogeo match most common AA in Loli?
sum(max.freq.ogeo == max.freq.loli)/length(pats.to.show)

## How many times does the most common AA in sepi match most common AA in the out group?
sum(max.freq.sepi == max.freq.outg)/length(pats.to.show)

## How many times does the most common AA in groe match most common AA in sepi?
