...
library(knitr)
rm(list=ls())
setwd("/home/jrm/scm/tibisay_cephalopods.git/sims/sim9")
...
\item 5000 codons
  ...
  tree: (((A\#1:0.428571,B\#1:0.428571)\#1:0.428571,(C\#1:0.428571,D\#1:0.428571)\#1:0.428571)\#1:0.428571,
((E:0.428571,F:0.428571):0.428571,(G:0.428571,H:0.428571):0.428571):0.428571);
\item $\kappa=2.0$ $p_0=0.375$ $p_1=0.375$ $\omega_0=0$
\end{itemize}

\section*{LR CDFs THERE IS A PROBLEM WITH NULL1 lnls}
