...
library(knitr)
rm(list=ls())
setwd("/home/jrm/scm/tibisay_cephalopods.git/sims/sim11")
...
\item Symmetric, 8-taxon tree with one internal, longer branch in the foreground \\
  The total tree length is 6.\\
  tree: (((A:0.26087,B:0.26087):0.26087,(C:0.26087,D:0.26087):0.26087)\#1:2.6087\\,((E:0.26087,F:0.26087):0.26087,(G:0.26087,H:0.26087):0.26087):0.26087);
