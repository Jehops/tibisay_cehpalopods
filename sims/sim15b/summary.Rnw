...
library(knitr)
rm(list=ls())
setwd("/home/jrm/scm/tibisay_cephalopods.git/sims/sim15b")
...
\begin{itemize}
\item Simulation under M3 k=3 with [p0,p1,p2] = [0.4,0.2,0.4] and [w0,w1,w2] = [0.1,0.5,1.0]
